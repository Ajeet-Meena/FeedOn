...
public class ApiURLConnection {
    ...
    public String httpPost(String URL, HashMap<String, String> param) {
        ...
        try {
            ...
            Log.d("encoding", getPostDataString(param));
            writer.flush();
            writer.close();
            os.close();
    ...
    public String httpGet(String stringUrl, HashMap<String, String> params) {
        ...
        try {
            ...
            Log.d("Debug_GetResponse", "The response is: " + response);
            inStream = urlConnection.getInputStream();

            // Convert the InputStream into a string
            contentAsString = readInstream(inStream);

            Log.d("Debug_GetResult", "Result: " + contentAsString);
            if( inStream != null ) {
                inStream.close();
            }
            ...
            e.printStackTrace();
            Log.d("Debug_", "Network error: MalformedURLException");
        } catch (IOException e) {

            e.printStackTrace();
            Log.d("Debug_", "IOException");
        } finally {
    ...
    public String readInstream(InputStream stream) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.d("Debug_readInstream", e.toString());
    ...
    public static class HttpRequester extends AsyncTask<String, Void, Boolean> {
        ...
        public HttpRequester(Context context, int requestCode, String URL, HashMap<String, String> hashMap, Boolean hasProgressDialog) {
            ...
            if( hashMap != null )
                Log.d("logHashMap", hashMap.toString());
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if( !networkAvailable ) {
                Toast.makeText(context,"Network unavialable",Toast.LENGTH_SHORT).show();
            }
